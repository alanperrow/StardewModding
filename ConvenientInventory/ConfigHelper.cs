...
namespace ConvenientInventory
{
    public static class ConfigHelper
    {
        ...
        /// <summary>
        /// Parses a config value for <see cref="ModConfig.QuickStackConfig.Range"/> and returns this value as an <see langword="int"/>
        ...
        /// <summary>
        /// Accepts an underlying int value for <see cref="ModConfig.QuickStackConfig.Range"/> and returns a corresponding string description of the value.
        /// </summary>
        ...
        /// <summary>
        /// Parses a provided config value for <see cref="ModConfig.QuickStackConfig.Range"/>, validates and constrains it, and returns the corresponding
        ...
        /// <summary>
        /// Parses a config value for <see cref="ModConfig.QuickStackConfig.Range"/> and returns the <see cref="QuickStackRangeType"/> associated with the value.
        /// </summary>
        /// <param name="value">The config value to parse.</param>
        ...
        /// <summary>
        /// Parses a config value for <see cref="ModConfig.QuickStackConfig.Range"/> as an <see langword="int"/> which represents the quick stack tile range.
        /// Throws an exception if <see cref="ModConfig.QuickStackConfig.Range"/> is not of type <see cref="QuickStackRangeType.Tile"/>.
        /// </summary>
